...
On le prend gaussien $K(x) = \frac{1}{\sqrt{2\pi}}e^{-\frac{1}{2}x^2}$
<br>
...
<br>
$\frac{1}{n}\sum_{i=1}^{n}K_h(x_0-X_i)Y_i = \frac{1}{n}\sum_{i=1}^{n}K_h(x_0-X_i)r(X_i) + \frac{1}{n}\sum_{i=1}^{n}K_h(x_0-X_i)\sigma\xi_i$
<br>
$\approx_{n \to \infty}{\rm I\!E}[K_h(x_0-X_i)r(X_i)]= \int_{\rm I\!R}K_h(x_0-x)r(x)g(x)dx)\approx_{h \to 0} r(x_0)g(x_0)$
<br>
On a vu au §1 que l'on peut estimer le terme $g(x_0)$ par un estimateur à noyau. Il nous reste donc à estimer $r(x_0)$. 
<br>

L'estimateur de Nadaraya-Watson est l'estimateur définit par la formule suivante
<br>
$\hat{r}_{n,h}(x_0)=\frac{n^{-1}\sum_{i=1}^{n}K_h(x_0-X_i)Y_i}{n^{-1}\sum_{i=1}^{n}K_h(x_0-X_i)} =  \sum_{i=1}^{n}w_{i,n}(x_0)Y_i$
<br>
avec $w_{i,n}(x_0)=\frac{K_h(x_0-X_i)}{\sum_{i=1}^{n}K_h(x_0-X_i)}$
<br>
