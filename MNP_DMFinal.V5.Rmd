...
### 1.1 Estimateur par noyau de la densité g(x) de X
...
### 1.2 Estimation par noyau gaussien de la densité g(x) de X avec un h optimal
...
$\begin{align} \text{Par définition } \tilde{\xi_i} = Y_i - \hat{r}_{n,h}^{(-)}(X_i) \text{ où } \hat{r}_{n,h}^{(-)}(x) \text{ est un estimateur de r(x).} \end{align}$
...
$\begin{align} \text{Puis en développant } \end{align}$
...
$\begin{align} \text{Comme } \hat{r}(X_i) \text{ est un estimateur de }  r(X_i) \text{ on a bien le résultat.}  \end{align}$
<div style="page-break-after: always;"></div>  
