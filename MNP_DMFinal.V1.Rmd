...
#### Petites valeurs de la fenêtre  h: 0.01 / 0.05
...
legend(3,1.2,c("h=0.01"),col=c("red"),lty=1:1)
...
legend(3,1.2,c("h=0.05"),col=c("blue"),lty=1:1)
...
rug(X, side = 1)
lines(estim_ucv$x,estim_ucv$y,type="l",col=1, lty=1)
lines(estim_dpik$x,estim_dpik$y,type="l",col=2, lty=2)
lines(estim_d$x,estim_d$y,type="l",col=3, lty=5)
lines(res040$x,res040$y,type="l",col=4, lty=6)
lines(res44$x,res44$y,type="l",col=5, lty=8)
lines(estim_sil$x,estim_sil$y,type="l",col=6, lty=9)

legend(5,0.8,c("h=Silverman", "bw.ucv", "dpik","density", "h=0.4","h=0.45"),
         col=c(1,2,3,4,5,6),
         lty=c(1,2,5,6,8,9))
```
