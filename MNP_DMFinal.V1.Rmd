...
----------- | --------------- | ---------- | --------- | ---------- | ------------ | 
0.01        | `r err001 `     |`r r2_001 ` |`r b_001 ` |`r mae_001 `| `r rmse_001 `|
0.03        | `r err003 `     |`r r2_003 ` |`r b_003 ` |`r mae_003 `| `r rmse_003 `|
0.05        | `r err005 `     |`r r2_005 ` |`r b_005 ` |`r mae_005 `| `r rmse_005 `|
...
bandwidth h | error quadratic |     R2     |   Biais   |     MAE    |      RMSE    |
----------- | --------------- | ---------- | --------- | ---------- | ------------ | 
0.08        | `r err008 `     |`r r2_008 ` |`r b_008 ` |`r mae_008 `| `r rmse_008 `|
0.20        | `r err020 `     |`r r2_020 ` |`r b_020 ` |`r mae_020 `| `r rmse_020 `|
0.40        | `r err040 `     |`r r2_040 ` |`r b_040 ` |`r mae_040 `| `r rmse_040 `|
0.70        | `r err070 `     |`r r2_070 ` |`r b_070 ` |`r mae_070 `| `r rmse_070 `|
1           | `r err100 `     |`r r2_100 ` |`r b_100 ` |`r mae_100 `| `r rmse_100 `|
...
```{r plot033_d1, echo=FALSE, fig.height=7, fig.width=10, warning=FALSE}
  ...
  legend(3,0.5,c("h=0.08","h=0.2", "h=0.3","h=0.4","h=0.7", "h=1"),
         col=c( "brown4","coral1",2,3,4,5),
         lty=c(1,2,5,6,8,9))
```
...
```{r include=FALSE, warning=FALSE}
  res025 <- bkde(x=X, bandwidth=0.025, gridsize= size, kernel = "normal",canonical=FALSE, truncate = TRUE)
  err025 <- mean((res025$y-X)**2)
  r2_025 <- R2(res025,X)
  b_025  <- Biais(res025,X)
  mae_025<- MAE(res025,X) 
  rmse_025<-RMSE(res025,X)
  
  res027 <- bkde(x=X, bandwidth=0.027, gridsize= size, kernel = "normal",canonical=FALSE, truncate = TRUE)
  err027 <- mean((res027$y-X)**2)
  r2_027 <- R2(res027,X)
  b_027  <- Biais(res027,X)
  mae_027<- MAE(res027,X) 
  rmse_027<-RMSE(res027,X)
  
  res033 <- bkde(x=X,bandwidth=0.033, gridsize= size, kernel = "normal",canonical=FALSE, truncate = TRUE)
  err033 <- mean((res033$y-X)**2)
  r2_033 <- R2(res033,X)
  b_033  <- Biais(res033,X)
  mae_033<- MAE(res033,X) 
  rmse_033<-RMSE(res033,X)
  
  res035 <- bkde(x=X,bandwidth=0.035, gridsize= size, kernel = "normal",canonical=FALSE, truncate = TRUE)
  err035 <- mean((res035$y-X)**2)
  r2_035 <- R2(res035,X)
  b_035  <- Biais(res035,X)
  mae_035<- MAE(res035,X) 
  rmse_035<-RMSE(res035,X)
```

bandwidth h | error quadratic |     R2     |   Biais   |     MAE    |      RMSE    |
----------- | --------------- | ---------- | --------- | ---------- | ------------ | 
0.01        | `r err001 `     |`r r2_001 ` |`r b_001 ` |`r mae_001 `| `r rmse_001 `|
0.025       | `r err025 `     |`r r2_025 ` |`r b_025 ` |`r mae_025 `| `r rmse_025 `|
0.027       | `r err027 `     |`r r2_027 ` |`r b_027 ` |`r mae_027 `| `r rmse_027 `|
0.03        | `r err003 `     |`r r2_003 ` |`r b_003 ` |`r mae_003 `| `r rmse_003 `|
0.033       | `r err033 `     |`r r2_033 ` |`r b_033 ` |`r mae_033 `| `r rmse_033 `|
0.035       | `r err035 `     |`r r2_035 ` |`r b_035 ` |`r mae_035 `| `r rmse_035 `|
...
plot(xlim, ylim, xlab="X",ylab="Y", log = "",  main="Estimation de la densité par noyaux pour h=0.025")
lines(res025$x,res025$y,type="l",col="black")
legend(5,1.5,c("h=0.025"),col=c("black"),lty=1:1)

plot(xlim, ylim, xlab="X",ylab="Y", log = "",  main="Estimation de la densité par noyaux pour h=0.027")
lines(res027$x,res027$y,type="l",col="red")
legend(5,1.5,c("h=0.027"),col=c("red"),lty=1:1)

plot(xlim, ylim, xlab="X",ylab="Y", log = "",  main="Estimation de la densité par noyaux pour h=0.03")
lines(res003$x,res003$y,type="l",col="green")
legend(5,1.5,c("h=0.03"),col=c("green"),lty=1:1)

plot(xlim, ylim, xlab="X",ylab="Y", log = "",  main="Estimation de la densité par noyaux pour h=0.033")
#rug(X)
lines(res033$x,res033$y,type="l",col="blue")
legend(5,1.5,c("h=0.033"),col=c("blue"),lty=1:1)
...
```{r fig.height=5, fig.width=8, echo=FALSE}
  ...
  plot(estim_ucv$x,estim_ucv$y,type="l",col="blue",  
       main ="Densité par noyaux pour h obtenues par différentes méthodes.", xlab="X", ylab="Y")
...
#rug(X, side = 1)
lines(res027$x,res027$y,type="l",col=1, lty=1)
lines(estim_ucv$x,estim_ucv$y,type="l",col=2, lty=1)
lines(estim_dpik$x,estim_dpik$y,type="l",col=3, lty=2)
lines(estim_d$x,estim_d$y,type="l",col=4, lty=5)
lines(estim_sil$x,estim_sil$y,type="l",col=5, lty=9)

legend(4,1.2,c("h = 0.027","bw.ucv = 0.056","dpik = 0.144", "density = 0.429", "h Silverman = 0.505"),
         col=c(1,2,3,4,5),
         lty=c(1,2,5,6,8))
```
...
##### Find optimum CV bandwidth, with sensible grid
```{r, echo=FALSE, fig.height=7, fig.width=10, eval=FALSE, echo=FALSE}
# Bandwidth
...
# Plot data: "Nadaraya–Watson avec ksmooth et différents h"
plot(Xo, Yo,pch=20,cex=0.01,xlab="X",ylab="Y",main="Nadaraya–Watson avec ksmooth et différents h")
rug(X, side = 1); rug(Y, side = 2)
lines(ksmooth, col = 2)
lines(ksmoothCV, col = "blue")
...
# Plot data: Nadaraya–Watson avec la fonction mNW et différents h
plot(Xo, Yo,pch=20,cex=0.01,xlab="X",ylab="Y",main="Nadaraya–Watson avec la fonction mNW et différents h")
rug(X, side = 1); rug(Y, side = 2)
lines(xGrid, mNW(x = xGrid, X = Xo, Y = Yo, h = h), col = 2)
lines(xGrid, mNW(x = xGrid, X = Xo, Y = Yo, h = hCV), col = "blue")
...
# Plot data: "Regression par polynômes locaux avec locpoly"
plot(Xo, Yo,pch=20,cex=0.01,xlab="X",ylab="Y", main ="Regression par polynômes locaux avec locpoly")
rug(X, side = 1); rug(Y, side = 2)
lines(lp2$x, lp2$y, col = 3, lty=1, pch = 12,lwd = 1)
lines(lp0$x, lp0$y, col = "blue", lty=1,pch = 12,lwd = 1)
